USE [master]
GO
/****** Object:  Database DBFACTURAS    Script Date: 15/03/2021 6:58:12 p. m. ******/
CREATE DATABASE DBFACTURAS
GO


ALTER DATABASE DBFACTURAS SET COMPATIBILITY_LEVEL = 140
GO

ALTER DATABASE DBFACTURAS SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE DBFACTURAS SET ANSI_NULLS OFF 
GO
ALTER DATABASE DBFACTURAS SET ANSI_PADDING OFF 
GO
ALTER DATABASE DBFACTURAS SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE DBFACTURAS SET ARITHABORT OFF 
GO
ALTER DATABASE DBFACTURAS SET AUTO_CLOSE OFF 
GO
ALTER DATABASE DBFACTURAS SET AUTO_SHRINK OFF 
GO
ALTER DATABASE DBFACTURAS SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE DBFACTURAS SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE DBFACTURAS SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE DBFACTURAS SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE DBFACTURAS SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE DBFACTURAS SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE DBFACTURAS SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE DBFACTURAS SET  DISABLE_BROKER 
GO
ALTER DATABASE DBFACTURAS SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE DBFACTURAS SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE DBFACTURAS SET TRUSTWORTHY OFF 
GO
ALTER DATABASE DBFACTURAS SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE DBFACTURAS SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE DBFACTURAS SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE DBFACTURAS SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE DBFACTURAS SET RECOVERY FULL 
GO
ALTER DATABASE DBFACTURAS SET  MULTI_USER 
GO
ALTER DATABASE DBFACTURAS SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE DBFACTURAS SET DB_CHAINING OFF 
GO
ALTER DATABASE DBFACTURAS SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE DBFACTURAS SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE DBFACTURAS SET QUERY_STORE = OFF
GO
...
CREATE OR ALTER procedure [dbo].[actualizar_CategoriaProd]
			 @IdCategoria int, 
...
--Crear SP para consultar todos los productos

CREATE OR ALTER PROCEDURE [dbo].[ConsultaProductos]
AS
BEGIN
	SET NOCOUNT ON;
	SELECT        
	TBLPRODUCTO.IdProducto, 
	TBLPRODUCTO.StrNombre, 
	TBLPRODUCTO.StrCodigo, 
	TBLPRODUCTO.NumPrecioCompra, 
	TBLPRODUCTO.NumPrecioVenta, 
	TBLPRODUCTO.IdCategoria,
	TBLPRODUCTO.StrDetalle, 
	TBLPRODUCTO.strFoto, 
	TBLPRODUCTO.NumStock
	FROM TBLPRODUCTO 
END
GO
...
USE [DBFACTURAS]
GO
/****** Object:  StoredProcedure [dbo].[ConsultaAdministracionSeguridad]    Script Date: 9/09/2025 8:40:22 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
USE [DBFACTURAS]
GO
/****** Object:  StoredProcedure [dbo].[ConsultaEmpleado]    Script Date: 9/09/2025 10:28:13 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
